...
<head>
    ...
    <link href={{asset("css/sb-admin-2.css/sb-admin-2.min.css")}} rel="stylesheet" type="text/css">
                    ...
                    @csrf
                        <div class="col-lg-6">
                            ...
                            <label for="email" class="form-label">E-mail Giriniz</label>
                                ...
                                <input type="email" class="form-control" id="email " name="email " placeholder="E-mail  Giriniz" value={{$user->email}}>
