...
<div class="background">
    <nav>
        <div class="navWrapper">
            <a href="{{"homepage"}}" id="logo"><img src="img/m.png" height="60" width="60" ></a>
            <div class="right">
...
<div class="section services">
    <div class="sectionWrapper">
        <div class="sectionWrapper">
            <h6>BİZ KİMİZ?</h6>
            <h2></h2>
            <p class="description">Mercan Medikal; revir malzemeleri, muayene ve hastane demirbaşları, İsgb ve Osgb paketleri, tibbi sarf
                malzemeleri, medikal ürünler, aile hekimliği ürünleri ve hijyen ürünleri gibi ihtiyaçlarınızı temin edebileceğiniz
                online medikal marketinizdir.
                Yüzlerce markanın binlerce çeşit ürününe uygun fiyat avantajlarıyla sahip olma fırsatı sunan sitemizde, nakliye ve
                kargo bedellerini şeffaf olarak inceleyebilecek, toptan seçeneği ile ürünleri çok daha ucuza alabi-
                leceksiniz.
                Mercan Medikal, yirmi senelik sektörel tecrübesi,  binlerce çeşit ürünü ile eczaneler,
                aile sağlığı merkezleri, hastaneler, revirler ve birçok iş sağlığı ve ortak sağlık güvenliği birimleri ile iş birliği yapmış
                ve bire bir diyalog fırsatını yakalamış bulunmaktadır.
                Bu tecrübe ve güven ortamının devamı için dijital dönüşüme yatırım yapıyor ve siz değerli kullanıcılarımıza daha
                ekonomik, süratli ve verimli hizmet etmenin gayesi ile hareket ediyoruz. İlk günden beri, tedarik zinciri boyunca
                eksiksiz ve kusursuz hizmet ilkemiz ile birlikte gelen memnuniyetiniz gururumuz olmuştur.</p>
            <div class="square blue"></div>
        <h6>AMACIMIZ</h6>
        <h2></h2>
        <p class="description">İnsanların temel ihtiyacı olan sağlık malzemelerine erişimi 81 ilimize de ulaştırmaktır.</p>
        <div class="square blue"></div>
        ...
        <div class="grid">
            ...
            <div class="card">
                <h3>Kaliteli Ürün</h3>
                <p>Ürünlerde oluşabilecek her türlü sorun da her zaman yanındayız.</p>
            </div>

            <!-- Social Media Marketing -->
            <div class="card">
                <h3>İletişim</h3>
                <p>Bizlere günü her saati ulaşabilirsiniz.</p>
            </div>
        </div>
    </div>
</div>
